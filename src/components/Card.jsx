...
const Card = ({ item }) => {
  ...
  return (
    <div className="shadow-[-5px_9px_11px_5px_rgba(0,_0,_0,_0.1)] w-[300px] h-[280px]  flex flex-col gap-3">
      <div className="flex flex-col gap-2 py-4 px-6">
        ...
        <p>
          {item.outcode} <span>{item.postcode}</span>
        </p>
      </div>
      <div className="bg-slate-200 w-[100%] h-[100%] py-4 px-6 flex flex-col gap-2">
