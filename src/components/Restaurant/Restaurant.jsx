...
const Restrorent = () => {
  ...
  const filterBtn = () => {
    if (inputVal.current.value === null || ratingVal.current.value === null)
      return;
    ...
    <div>
      <div className="flex justify-between px-8 py-4">
        <div className="flex gap-4 items-center">
          ...
          <button
            onClick={filterBtn}
            className="bg-blue-600 py-2 outline-none px-4 rounded-lg text-white font-bold "
          >
            Search
          </button>
        </div>
        <div className="flex gap-2 items-center">
          ...
          <input
            ref={ratingVal}
            className="border p-2 w-[100px] outline-none border-2"
            type="number"
          />
        </div>
      </div>
